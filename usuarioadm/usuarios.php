          ...
          <form action="../registrobe.php" method="post" enctype="multipart/form-data">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="mb-3">
                  <input class="form-control" type="text" name="FolioControl" placeholder="Folio Control">
                </div>
            ...
            <button type="submit" class="btn btn-primary" name="register" value="Enviar">Registrar</button>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text" name="Matricula" value="<?php echo $row['Matricula']; ?>">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <input  type="hidden" class="form-control" type="password" name="contrasena" value="<?php echo $row['contrasena']; ?>">
            </div>
        </div>
        <div class="col-md-6">
            <!-- Segunda Columna -->
          ...
          <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="FolioControl">Folio Control:</label>
                <input class="form-control" type="text" name="FolioControl" value="<?php echo $row['FolioControl']; ?>">
            </div>
